...
<head>
    ...
    <title>Recept Bewerken - Stop de Ontkoking</title>
            ...
            <div class="col-md-12">
                <div class="content">
                    <div class="alert alert-light form-container">
                        <h1>Bewerk je recept</h1>
                        <form action="./?id=<?= htmlspecialchars($receptId) ?>" method="post">
                            <input type="hidden" name="id" value="<?= htmlspecialchars($receptId) ?>">
                            ...
                            <br>
                            <input type="submit" class="btn btn-danger" value="Recept Bijwerken">
                        </form>
                    </div>
                </div>
            </div>
