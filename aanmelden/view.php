...
<head>
  ...
  <title>Aanmelden Bij Stop De Ontkoking</title>
        ...
        <div class="content flex-fill d-flex justify-content-center align-items-center">
          <div class="alert alert-light m-3 w-75">
            <form action="./" method="post" class="form">
              <h1 class="text-center">Meld je aan bij Stop de ontkoking!</h1>
              <p class="text-center">
                Als je je aanmeld je kun je jouw eigen recepten toevoegen en delen met anderen!
              </p>
